...
describe('binarySearchTree', () => {
  ...
  test('it should add a child node to the right of the root node', () => {
    ...
    let rootNode = new BSTNode(36);
    bst.insertNode(rootNode);
    let newNode = new BSTNode(46);
    bst.insertNode(newNode);
    expect(rootNode.right.data).toEqual(46)
  });

  test('it should be able to add a child to the left of a child node', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insertNode(rootNode);
  ...
  test('it should be able to add a child to the right of a child node', () => {
    let bst = new BST();
    let rootNode = new BSTNode(36);
    bst.insertNode(rootNode);
